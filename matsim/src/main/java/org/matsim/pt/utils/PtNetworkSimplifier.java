 ...
 * when merging links.
 * 
 * Originally from {@link playground.vsp.andreas.utils.pt.PTNetworkSimplifier}
 * 
 * @author aneumann
 *
 */
public class PtNetworkSimplifier {
	...
	private final Counter counter = new Counter("[PtNetworkSimplifier] processed node # ");
	...
	private boolean areLinksMergeable(final TransitLine transitLine, final Link inLink, final Link outLink) {
